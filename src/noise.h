...
/// @copydoc inoise8(fl::u16, fl::u16)
/// @param z z-axis coordinate on noise map (3D)
extern uint8_t inoise8(fl::u16 x, fl::u16 y, fl::u16 z);

/// @copydoc inoise8(fl::u16)
/// @param y y-axis coordinate on noise map (2D)
extern uint8_t inoise8(fl::u16 x, fl::u16 y);

/// 8-Bit, fixed point implementation of Perlin's noise. 
/// @see inoise8_raw()
/// @returns scaled noise value as an unsigned integer, 0-255
/// @param x x-axis coordinate on noise map (1D)
extern uint8_t inoise8(fl::u16 x);
...
/// @copydoc inoise8_raw(fl::u16, fl::u16)
/// @param z z-axis coordinate on noise map (3D)
extern int8_t inoise8_raw(fl::u16 x, fl::u16 y, fl::u16 z);

/// @copydoc inoise8_raw(fl::u16)
/// @param y y-axis coordinate on noise map (2D)
extern int8_t inoise8_raw(fl::u16 x, fl::u16 y);
...
/// @param x x-axis coordinate on noise map (1D)
extern int8_t inoise8_raw(fl::u16 x);
...
/// range of a fl::u16 averaging around 32768.
...
void fill_raw_noise8(uint8_t *pData, uint8_t num_points, uint8_t octaves, fl::u16 x, int scalex, fl::u16 time);
...
/// @param time the time position for the noise field
void fill_raw_2dnoise8(uint8_t *pData, int width, int height, uint8_t octaves, q44 freq44, fract8 amplitude, int skip, fl::u16 x, int16_t scalex, fl::u16 y, int16_t scaley, fl::u16 time);
void fill_raw_2dnoise8(uint8_t *pData, int width, int height, uint8_t octaves, fl::u16 x, int scalex, fl::u16 y, int scaley, fl::u16 time);
...
/// @param scaley the scale (distance) between y points when filling in noise
/// @param time the time position for the noise field
void fill_raw_2dnoise8(uint8_t *pData, int width, int height, uint8_t octaves, fl::u16 x, int16_t scalex, fl::u16 y, int16_t scaley, fl::u16 time);

/// Fill a 2D 8-bit buffer with noise, using inoise16() 
/// @copydetails fill_raw_2dnoise8(uint8_t*, int, int, uint8_t, fl::u16, int16_t, fl::u16, int16_t, fl::u16)
...
/// @param amplitude noise amplitude
/// @param skip how many noise maps to skip over, incremented recursively per octave
void fill_raw_2dnoise16(fl::u16 *pData, int width, int height, uint8_t octaves, q88 freq88, fract16 amplitude, int skip, uint32_t x, int32_t scalex, uint32_t y, int32_t scaley, uint32_t time);
...
void fill_noise8(CRGB *leds, int num_leds,
            uint8_t octaves, fl::u16 x, int scale,
            uint8_t hue_octaves, fl::u16 hue_x, int hue_scale,
            fl::u16 time);
...
void fill_noise16(CRGB *leds, int num_leds,
            uint8_t octaves, fl::u16 x, int scale,
            uint8_t hue_octaves, fl::u16 hue_x, int hue_scale,
            fl::u16 time, uint8_t hue_shift=0);
...
void fill_2dnoise8(CRGB *leds, int width, int height, bool serpentine,
            uint8_t octaves, fl::u16 x, int xscale, fl::u16 y, int yscale, fl::u16 time,
            uint8_t hue_octaves, fl::u16 hue_x, int hue_xscale, fl::u16 hue_y, fl::u16 hue_yscale,fl::u16 hue_time,bool blend);
...
void fill_2dnoise16(CRGB *leds, int width, int height, bool serpentine,
            ...
            uint8_t hue_octaves, fl::u16 hue_x, int hue_xscale, fl::u16 hue_y, fl::u16 hue_yscale,fl::u16 hue_time, bool blend, fl::u16 hue_shift=0);
