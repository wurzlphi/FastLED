...
void bilinearExpandArbitrary(const CRGB *input, CRGB *output,
                             fl::u16 inputWidth, fl::u16 inputHeight,
                             fl::XYMap xyMap)
...
void bilinearExpand(const CRGB *input, CRGB *output, fl::u16 inputWidth,
                    fl::u16 inputHeight, fl::XYMap xyMap)
...
inline void bilinearExpand(const CRGB *input, CRGB *output, fl::u16 inputWidth,
                           fl::u16 inputHeight, fl::XYMap xyMap) {
