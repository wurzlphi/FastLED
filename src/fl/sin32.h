...
//
// sin16 and cos16 are faster and more accurate funtions that take fl::u16 as
...
FASTLED_FORCE_INLINE static int16_t sin16lut(fl::u16 angle) {
...
// 0 to 65536 is a full circle
// output is between -32767 and 32767
FASTLED_FORCE_INLINE static int16_t cos16lut(fl::u16 angle) {
    uint8_t angle256 = angle / 256;
    int32_t subAngle = angle % 256;
