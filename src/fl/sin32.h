...
// that's 32767 * 65536
// this is because I use fl::i16 look up table to interpolate the results
//
// sin16 and cos16 are faster and more accurate funtions that take u16 as
// arguments and return fl::i16 as output they can replace the older
...
extern const fl::i16 *sinArray;

extern const fl::i16 *cosArray;

// 0 to 16777216 is a full circle
// output is between -2147418112 and 2147418112
FASTLED_FORCE_INLINE static fl::i32 sin32(fl::u32 angle) {
    fl::u8 angle256 = angle / 65536;
    fl::i32 subAngle = angle % 65536;
...
// 0 to 16777216 is a full circle
// output is between -2147418112 and 2147418112
FASTLED_FORCE_INLINE static fl::i32 cos32(fl::u32 angle) {
    fl::u8 angle256 = angle / 65536;
    fl::i32 subAngle = angle % 65536;
...
FASTLED_FORCE_INLINE static fl::i16 sin16lut(u16 angle) {
    fl::u8 angle256 = angle / 256;
    fl::i32 subAngle = angle % 256;
...
// 0 to 65536 is a full circle
// output is between -32767 and 32767
FASTLED_FORCE_INLINE static fl::i16 cos16lut(u16 angle) {
    fl::u8 angle256 = angle / 256;
    fl::i32 subAngle = angle % 256;
