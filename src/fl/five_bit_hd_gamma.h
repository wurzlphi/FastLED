...
// Exposed for testing.
uint8_t five_bit_bitshift(fl::u16 r16, fl::u16 g16, fl::u16 b16,
...
//    uint8_t r8, uint8_t g8, uint8_t b8,
//    fl::u16* r16, fl::u16* g16, fl::u16* b16) {
//      cout << "hello world\n";
//  }
//  FASTLED_NAMESPACE_END
...
// This function is located somewhere else in your project, so it's declared
// extern here.
extern void five_bit_hd_gamma_function(CRGB color, fl::u16 *r16, fl::u16 *g16,
                                       fl::u16 *b16);
#else
inline void five_bit_hd_gamma_function(CRGB color, fl::u16 *r16, fl::u16 *g16,
                                       fl::u16 *b16) {
...
inline uint8_t five_bit_bitshift(fl::u16 r16, fl::u16 g16, fl::u16 b16,
                                 uint8_t brightness, CRGB *out,
                                 uint8_t *out_power_5bit) {

    auto max3 = [](fl::u16 a, fl::u16 b, fl::u16 c) {
    ...
    // driver brightness.
    fl::u16 max_component = max3(r16, g16, b16);
