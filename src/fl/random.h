...
public:
    ...
    explicit fl_random(fl::u16 seed) : seed_(seed) {}
    ...
    fl::u16 random16(fl::u16 min, fl::u16 max) {
        return (*this)(min, max);
    }
};
