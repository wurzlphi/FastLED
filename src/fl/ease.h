...
/// Takes an input value 0-65535 and returns an eased value 0-65535
fl::u16 easeInOutQuad16(fl::u16 i);
...
/// Takes an input value 0-65535 and returns an eased value 0-65535
fl::u16 easeInOutCubic16(fl::u16 i);
...
fl::u16 ease16(EaseType type, fl::u16 i);
void ease16(EaseType type, fl::u16* src, fl::u16* dst, fl::u16 count);
...
inline fl::u16 ease16(EaseType type, fl::u16 i) {
    switch (type) {
...
inline void ease16(EaseType type, fl::u16* src, fl::u16* dst, fl::u16 count) {
    switch (type) {
