...
fl::u8 ease8(EaseType type, fl::u8 i);
void ease8(EaseType type, fl::u8* src, fl::u8* dst, fl::u8 count);
...
inline fl::u8 ease8(EaseType type, fl::u8 i) {
    switch (type) {
        case EASE_NONE: return i;
...
inline void ease8(EaseType type, fl::u8* src, fl::u8* dst, fl::u8 count) {
    switch (type) {
        case EASE_NONE: return;
        case EASE_IN_QUAD: {
            for (fl::u8 i = 0; i < count; i++) {
